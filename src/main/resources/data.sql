...
(SELECT ID FROM units WHERE name = 'C&CA'),(SELECT ID FROM enumerationlevels WHERE code ='A4')),
(0, 'Peter', 'Van Petegehem', PARSEDATETIME('01/08/1995','dd/MM/yyyy'), PARSEDATETIME('14/04/2023','dd/MM/yyyy'),
(SELECT id FROM units WHERE name = 'C&CA'),(SELECT ID FROM enumerationlevels WHERE code ='A3')),
(0, 'Dirk', 'Maes', PARSEDATETIME('16/05/1990','dd/MM/yyyy'), PARSEDATETIME('01/02/2015','dd/MM/yyyy'),
(SELECT id FROM units WHERE name = 'C&CA'),(SELECT ID FROM enumerationlevels WHERE code ='C1')),
...
(SELECT id FROM units WHERE name = 'Sales'),(SELECT ID FROM enumerationlevels WHERE code ='E2'));